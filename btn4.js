...
var mobbtn32 = document.getElementById('mob-btn32')
var mobbtn33 = document.getElementById('mob-btn33')
var mobbtn34 = document.getElementById('mob-btn34')
var mobbtn35 = document.getElementById('mob-btn35')
...
btn32.addEventListener('click',()=>{
    ...
    btn34.classList.remove('active') 
    btn35.classList.remove('active') 
    heading2.innerHTML = "Lorry Broker Assistance "
    img2.src = "image/icons/Icons32.png"
    p2.innerHTML = "To make highway work more smoothly lorry broker assistant is also available to provide lorry and driver for this solution."
})
btn33.addEventListener('click',()=>{
    ...
    btn34.classList.remove('active') 
    btn35.classList.remove('active') 
    heading2.innerHTML = "Transporter Assistance "
    img2.src = "image/icons/Icons33.png"
    p2.innerHTML = " Transporter facility is also available to ensure the efficient and smooth logistics flow on the highway and to provide the best work to every highway entity."
})
...
btn35.addEventListener('click',()=>{
    ...
    heading2.innerHTML = "Accessories Availability "
    img2.src = "image/icons/Icons35.png"
    p2.innerHTML = "We care about your appearance keeping this in mind we have a wide range of accessories collection for every vehicle to ensure the best of you on Highways."
})
...
mobbtn8.addEventListener('click',()=>{
    ...
    mobbtn32.classList.remove('active') 
    mobbtn33.classList.remove('active') 
    mobbtn34.classList.remove('active') 
    mobbtn35.classList.remove('active') 
    heading2.innerHTML = "RTO Consultation "
    img2.src = "image/icons/Icons8.png"
    p2.innerHTML = "RTO consultation is available for the driver to provide every RTO facilities providing   help for licence problem, Vehicle paper and Document problem anytime on the Highway."
})
...
mobbtn32.addEventListener('click',()=>{
    mobbtn8.classList.remove('active')
    mobbtn9.classList.remove('active')
    mobbtn10.classList.remove('active') 
    mobbtn31.classList.remove('active') 
    mobbtn32.classList.add('active') 
    mobbtn33.classList.remove('active') 
    mobbtn34.classList.remove('active') 
    mobbtn35.classList.remove('active') 
    heading2.innerHTML = "Lorry Broker Assistance "
...
mobbtn33.addEventListener('click',()=>{
    mobbtn8.classList.remove('active')
    mobbtn9.classList.remove('active')
    mobbtn10.classList.remove('active') 
    mobbtn31.classList.remove('active') 
    mobbtn32.classList.remove('active') 
    mobbtn33.classList.add('active') 
    mobbtn34.classList.remove('active') 
    mobbtn35.classList.remove('active') 
    heading2.innerHTML = "Transporter Assistance "
    img2.src = "image/icons/Icons33.png"
...
mobbtn35.addEventListener('click',()=>{
    mobbtn8.classList.remove('active')
    mobbtn9.classList.remove('active')
    mobbtn10.classList.remove('active') 
    mobbtn31.classList.remove('active') 
